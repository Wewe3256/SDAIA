...
public class dbDAOEMPLOYEeS {
    ...
    public void insertEMP( dbhwemployy d) throws SQLException {
    ...
    public void updateDept( dbhwemployy d) throws SQLException {
        Connection conn = DriverManager.getConnection(URL);
    ...
    public void deletEmp(int empId) throws SQLException {
        Connection conn = DriverManager.getConnection(URL);
    ...
    public dbhwemployy selectEmp(int deptId) throws SQLException {
        Connection conn = DriverManager.getConnection(URL);
    ...
    public ArrayList<dbhwemployy> selectAllDepts() throws SQLException {
        Connection conn = DriverManager.getConnection(URL);
